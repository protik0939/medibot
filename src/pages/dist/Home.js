...
function Home() {
    return (React.createElement("div", { className: "home-container" },
        ...
        React.createElement("div", { className: "github-section" },
            React.createElement("h2", { className: "github-title" }, "Project's Codes on Github"),
            React.createElement("div", { className: "github-links" },
                React.createElement(react_router_dom_1.Link, { to: "https://github.com/protik0939/Medibot-Arduino-Code", target: "_blank", rel: "noopener noreferrer" },
                    React.createElement(GitHubIcon, null),
                    " Arduino Code"),
                React.createElement(react_router_dom_1.Link, { to: "https://github.com/protik0939/Medibot-esp8266-code", target: "_blank", rel: "noopener noreferrer" },
                    React.createElement(GitHubIcon, null),
                    " ESP8266 Code"),
                React.createElement(react_router_dom_1.Link, { to: "https://github.com/protik0939/medibot", target: "_blank", rel: "noopener noreferrer" },
                    React.createElement(GitHubIcon, null),
                    " Frontend Code"),
                React.createElement(react_router_dom_1.Link, { to: "https://github.com/protik0939/medibot-backend", target: "_blank", rel: "noopener noreferrer" },
                    React.createElement(GitHubIcon, null),
                    " Backend Code")))));
}
